...
import '../../models/messio_user.dart';
...
class ChatBloc extends Bloc<ChatEvent, ChatState> {
  ...
  Future<void> mapSendAttachmentEventToState(
  ...
  Future<void> mapRegisterActiveChatEventToState(
      RegisterActiveChatEvent event, Emitter<ChatState> emit) async {
    activeChatId = event.activeChatId;
  }

  Future<void> mapReceivedChatsEventToState(
      ReceivedChatsEvent event, Emitter<ChatState> emit) async {
    emit(FetchedChatListState(event.chatList));
  }

  Future<void> mapPageChangedEventToState(
      PageChangedEvent event, Emitter<ChatState> emit) async {
    activeChatId = event.activeChat.chatId;
    emit(PageChangedState(event.index, event.activeChat));
  }

  Future<void> mapReceivedMessagesEventToState(
      ReceivedMessagesEvent event, Emitter<ChatState> emit) async {
  ...
  Future<void> mapSendTextMessageEventToState(
  ...
  Future<void> mapToggleEmojiKeyboardEventToState(
      ToggleEmojiKeyboardEvent event, Emitter<ChatState> emit) async {
