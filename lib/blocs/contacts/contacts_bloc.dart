...
class ContactsBloc extends Bloc<ContactsEvent, ContactsState> {
  ...
  Future<void> mapReceivedContactsEventToState(
      ReceivedContactsEvent event, Emitter<ContactsState> emit) async {
    emit(FetchedContactsState(event.contacts));
  }

  Future<void> mapFetchContactsEventToState(
  ...
  Future<void> mapAddContactEventToState(
